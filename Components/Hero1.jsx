...
function Hero1() {
  return (
    <div className='h-fit overflow-x-hidden md:flex justify-around md:pt-[20vh] pt-[10vh] pl-[3vw] pr-[3vw] bg-gradient-to-b from-[#0F162A] to-[#15263f]/70'>
      ...
      <div className='w-full'>
        ...
        {/* FIX HERE */}
        <div className='mt-10 mr-5 flex w-full max-w-full'>
            <input 
              type="text"
              className='border bg-gray-500/20 border-gray-500/20 outline-none md:h-[7vh] md:w-[25vw] h-[7vh] w-full rounded-sm p-3'
              placeholder='🔗      https://github.com/facebook/react'
            />
            <button className='border font-medium rounded-r-sm text-sm border-black/20 text-black bg-gradient-to-b from-blue-400 to-blue-600 md:px-2 px-1 cursor-pointer'>
              Analyse⚡
            </button>
        </div>
      </div>
      ...
      <div className='mt-10 md:mt-0 text-center mr-3'>
        <img src="./rocket.webp" className='rounded-xl border border-white/20 md:-mt-10 max-w-full' alt="rocket-img" />
